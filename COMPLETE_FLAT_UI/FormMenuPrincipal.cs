...
namespace COMPLETE_FLAT_UI
{
    public partial class FormMenuPrincipal : Form
    {
        ...
        private void btnMembresia_Click(object sender, EventArgs e)
        {
          ...
          {
              FormListaServicios fs = new FormListaServicios();
              fs.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
             AbrirFormEnPanel(fs);
          }
          ...
          private void button2_Click(object sender, EventArgs e)
          {
               ...
               ff.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
               AbrirFormEnPanel(ff);
          }

          private void btnSalir_Click_1(object sender, EventArgs e)
          {
               FormBasedeDatos bb = new FormBasedeDatos();
               bb.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
               AbrirFormEnPanel(bb);
          }
